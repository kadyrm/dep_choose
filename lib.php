...
//$query = get_greater_than($tblname,$post_data,"humanities");
//echo $query;
$result = connect($hostname,$username,$password,$dbname, $tblname, $dbhandle, $query);
...
function get_greater_than($tblname, $score, $exam_type){
      $query = "SELECT * FROM `".$tblname."` WHERE `score_min` >= ".$score." AND `exam_type` = '".$exam_type."'";
     return $query; 
}
